 ...
 */
template <size_t I, size_t F, template <size_t, size_t, typename> typename FixedType, typename WordType = uint64_t> class uniform_fixed_point_distribution
{
public:
    using result_type = FixedType<I,F,WordType>;
