...
//    {
//        const N val =
//            GENERATE(take(50, random(std::numeric_limits<N>::min(), std::numeric_limits<N>::max())));
//
...
//}
//
//TEMPLATE_TEST_CASE_SIG("Casting signed integers (WordType = uint32_t)", "[integer][unsigned][casting]",
//                       AARITH_INT_TEST_SIGNATURE,
////                       (8, uint64_t)
//                       AARITH_UINT_TEST_TEMPLATE_NATIVE_SIZES_PARAM_RANGE)
//{
//    using I = aarith::uinteger<W, uint32_t>;
//    using N = WordType;
//
//    GIVEN("A random native integer")
//    {
...
//}
//
//TEMPLATE_TEST_CASE_SIG("Casting signed integers (WordType = uint32_t)", "[integer][signed][casting]",
//                       AARITH_INT_TEST_SIGNATURE,
////                       (8, uint64_t)
//                       AARITH_SINT_TEST_TEMPLATE_NATIVE_SIZES_PARAM_RANGE)
//{
//    using I = aarith::integer<W, uint32_t>;
//    using N = WordType;
//
//    GIVEN("A random native integer")
//    {
...
//
//
//TEMPLATE_TEST_CASE_SIG("Casting signed integers (WordType = uint16_t)", "[integer][unsigned][casting]",
//                       AARITH_INT_TEST_SIGNATURE,
////                       (8, uint64_t)
//                       AARITH_UINT_TEST_TEMPLATE_NATIVE_SIZES_PARAM_RANGE)
//{
//    using I = aarith::uinteger<W, uint16_t>;
//    using N = WordType;
//
//    GIVEN("A random native integer")
//    {
...
TEMPLATE_TEST_CASE_SIG("Casting signed integers (WordType = uint16_t)", "[integer][signed][casting]",
                       AARITH_INT_TEST_SIGNATURE,
                       (32, int32_t)
//                       AARITH_SINT_TEST_TEMPLATE_NATIVE_SIZES_PARAM_RANGE
                       )
{
    using I = aarith::integer<W, uint16_t>;
    using N = WordType;

    GIVEN("A random native integer")
    {
        const N val =
            GENERATE(take(1, random(std::numeric_limits<N>::min(), std::numeric_limits<N>::max())));
...
TEST_CASE("Dinge")
{
    using I = aarith::integer<32,uint16_t>;
