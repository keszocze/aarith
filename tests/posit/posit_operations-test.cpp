...
static void require_fraction(const P8& p, size_t expected_nfrac, uint16_t expected_fraction_value)
{
...
SCENARIO("Find the fraction bits")
{
    GIVEN("Some arbitrary posit values")
    {
        THEN("Assert that the returned fraction values are correct")
        {
            ...
            require_fraction(P8(0b100000U), 0, 0);
            require_fraction(P8(0b100001U), 0, 0);
            require_fraction(P8(0b100010U), 0, 0);
            require_fraction(P8(0b100011U), 0, 0);
            require_fraction(P8(0b100100U), 0, 0);
            require_fraction(P8(0b100101U), 0, 0);
            require_fraction(P8(0b100110U), 0, 0);
            require_fraction(P8(0b100111U), 0, 0);
            require_fraction(P8(0b101000U), 0, 0);
            require_fraction(P8(0b101001U), 1, 1);
            require_fraction(P8(0b101010U), 1, 0);
            require_fraction(P8(0b101011U), 1, 1);
            require_fraction(P8(0b101100U), 1, 0);
            require_fraction(P8(0b101101U), 1, 1);
            require_fraction(P8(0b101110U), 1, 0);
            require_fraction(P8(0b101111U), 1, 1);
            require_fraction(P8(0b110000U), 1, 0);
            require_fraction(P8(0b110001U), 1, 1);
            require_fraction(P8(0b110010U), 1, 0);
            require_fraction(P8(0b110011U), 1, 1);
            require_fraction(P8(0b110100U), 1, 0);
            require_fraction(P8(0b110101U), 1, 1);
            require_fraction(P8(0b110110U), 1, 0);
            require_fraction(P8(0b110111U), 1, 1);
            require_fraction(P8(0b111000U), 1, 0);
            require_fraction(P8(0b111001U), 0, 0);
            require_fraction(P8(0b111010U), 0, 0);
            require_fraction(P8(0b111011U), 0, 0);
            require_fraction(P8(0b111100U), 0, 0);
            require_fraction(P8(0b111101U), 0, 0);
            require_fraction(P8(0b111110U), 0, 0);
            require_fraction(P8(0b111111U), 0, 0);

            require_fraction(P8(0b000000U), 0, 0);
            require_fraction(P8(0b000001U), 0, 0);
            require_fraction(P8(0b000010U), 0, 0);
            require_fraction(P8(0b000011U), 0, 0);
            require_fraction(P8(0b000100U), 0, 0);
            require_fraction(P8(0b000101U), 0, 0);
            require_fraction(P8(0b000110U), 0, 0);
            require_fraction(P8(0b000111U), 0, 0);
            require_fraction(P8(0b001000U), 1, 0);
            require_fraction(P8(0b001001U), 1, 1);
            require_fraction(P8(0b001010U), 1, 0);
            require_fraction(P8(0b001011U), 1, 1);
            require_fraction(P8(0b001100U), 1, 0);
            require_fraction(P8(0b001101U), 1, 1);
            require_fraction(P8(0b001110U), 1, 0);
            require_fraction(P8(0b001111U), 1, 1);
            require_fraction(P8(0b010000U), 1, 0);
            require_fraction(P8(0b010001U), 1, 1);
            require_fraction(P8(0b010010U), 1, 0);
            require_fraction(P8(0b010011U), 1, 1);
            require_fraction(P8(0b010100U), 1, 0);
            require_fraction(P8(0b010101U), 1, 1);
            require_fraction(P8(0b010110U), 1, 0);
            require_fraction(P8(0b010111U), 1, 1);
            require_fraction(P8(0b011000U), 0, 0);
            require_fraction(P8(0b011001U), 0, 0);
            require_fraction(P8(0b011010U), 0, 0);
            require_fraction(P8(0b011011U), 0, 0);
            require_fraction(P8(0b011100U), 0, 0);
            require_fraction(P8(0b011101U), 0, 0);
            require_fraction(P8(0b011110U), 0, 0);
            require_fraction(P8(0b011111U), 0, 0);
        }
    }
}
